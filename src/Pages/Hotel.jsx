...
function Hotel() {
  ...
  const products = [
    ...
    { name: 'Returnal Game',story:'-Isolated and alone, she finds herself fighting tooth and nail for survival. Again and again, she’s defeated – forced to restart her journey every time she dies.', price: 'R1,360.00',sale:'R680.00', image: 'https://gmedia.playstation.com/is/image/SIEPDC/tmop-returnal-image-block-01-en-20apr21?$1600px$' },
    ...
    { name: 'Gran Turismo 7',story:'-Explore all that the Real Driving Simulator can be with new tools to help you put your own mark on your driving experiences.', price: 'R1,340.75',sale:'R 1,130.00', image: 'https://image.api.playstation.com/vulcan/ap/rnd/202202/2806/y4liLwBLXmhWHIvakDIMG1T1.jpg?w=780&thumb=false' },
